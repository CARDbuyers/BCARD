...
In order to support loading of multiple wallets in CARDbuyers-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is CARDbuyers.cpp.
...
Changes to CARDbuyers.cpp
----------------------
CARDbuyers.cpp is the entry point into CARDbuyers-qt, and as such, will require some minor modifications to provide hooks for
