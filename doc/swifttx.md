...
This mechanism has been integrated into Bitcore-Node-CARDbuyers which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CARDbuyers-Project/insight-api-CARDbuyers#web-socket-api](https://github.com/CARDbuyers-Project/insight-api-CARDbuyers#web-socket-api) 
* API: [https://github.com/CARDbuyers-Project/insight-api-CARDbuyers#swifttx-transactions](https://github.com/CARDbuyers-Project/insight-api-CARDbuyers#swifttx-transactions) 
...
By default, the CARDbuyers Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CARDbuyers Core daemon:
