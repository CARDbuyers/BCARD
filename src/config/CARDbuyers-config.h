/* src/config/CARDbuyers-config.h.  Generated from CARDbuyers-config.h.in by configure.  */
/* src/config/CARDbuyers-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BCARD_CONFIG_H

#define BCARD_CONFIG_H
...
#define PACKAGE_NAME "CARDbuyers Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CARDbuyers Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "CARDbuyers"
