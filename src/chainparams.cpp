...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 48451;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // CARDbuyers starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // CARDbuyers: 1 day
        nTargetSpacing = 1 * 60;  // CARDbuyers: 1 minute
        nLastPOWBlock = 140;
        nMaturity = 59;
...
{
	return "B8WJkRchZfsiLSc8hwJFHX5eijXgdFj3wx";
}
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet CARDbuyers addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet CARDbuyers script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet CARDbuyers BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet CARDbuyers BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet CARDbuyers BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // CARDbuyers: 1 day
        nTargetSpacing = 1 * 60;        // CARDbuyers: 1 minutes
