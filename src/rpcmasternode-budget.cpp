...
Value preparebudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"CARDbuyers-address\" monthy-payment\n"
            ...
            "5. \"CARDbuyers-address\":   (string, required) CARDbuyers address to send payments to\n"
...
Value submitbudget(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"CARDbuyers-address\" monthy-payment \"fee-tx\"\n"
