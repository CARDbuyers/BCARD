...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CARDbuyers Core"),
     ...
     * override -datadir in the CARDbuyers.conf file in the default data directory
     * (to be consistent with CARDbuyersd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
