                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CARDbuyers Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CARDbuyers address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and CARDbuyers: URIs)"));
	...
	infoAction = new QAction(QIcon(":/icons/info"), tr("&Infos"), this);
    infoAction->setStatusTip(tr("Info Actions for BCARD"));
    infoAction->setToolTip(infoAction->statusTip());
	...
	connect(infoAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CARDbuyers Core"), this);
    aboutAction->setStatusTip(tr("Show information about CARDbuyers Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CARDbuyers"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CARDbuyers addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CARDbuyers addresses"));
    ...
    openAction->setStatusTip(tr("Open a CARDbuyers: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CARDbuyers Core help message to get a list with possible CARDbuyers command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CARDbuyers Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CARDbuyers network", "", count));
}
...
{
    QString strTitle = tr("CARDbuyers Core"); // default title
