...
/** Utility functions used by the CARDbuyers Qt UI.
 */
namespace GUIUtil
{
...
// Render CARDbuyers addresses in monospace font
...
// Parse "CARDbuyers:" URI into recipient object, return true on successful parsing
