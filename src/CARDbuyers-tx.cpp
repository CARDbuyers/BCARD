...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CARDbuyers Core CARDbuyers-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  CARDbuyers-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded CARDbuyers transaction") + "\n" +
                               "  CARDbuyers-tx [options] -create [commands]   " + _("Create hex-encoded CARDbuyers transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded CARDbuyers transaction
