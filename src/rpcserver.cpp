...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CARDbuyers server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CARDbuyers server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CARDbuyers features */
        {"CARDbuyers", "masternode", &masternode, true, true, false},
        {"CARDbuyers", "listmasternodes", &listmasternodes, true, true, false},
        {"CARDbuyers", "getmasternodecount", &getmasternodecount, true, true, false},
        {"CARDbuyers", "masternodeconnect", &masternodeconnect, true, true, false},
        {"CARDbuyers", "masternodecurrent", &masternodecurrent, true, true, false},
        {"CARDbuyers", "masternodedebug", &masternodedebug, true, true, false},
        {"CARDbuyers", "startmasternode", &startmasternode, true, true, false},
        {"CARDbuyers", "createmasternodekey", &createmasternodekey, true, true, false},
        {"CARDbuyers", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"CARDbuyers", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"CARDbuyers", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"CARDbuyers", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"CARDbuyers", "getmasternodescores", &getmasternodescores, true, true, false},
        {"CARDbuyers", "mnbudget", &mnbudget, true, true, false},
        {"CARDbuyers", "preparebudget", &preparebudget, true, true, false},
        {"CARDbuyers", "submitbudget", &submitbudget, true, true, false},
        {"CARDbuyers", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"CARDbuyers", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"CARDbuyers", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"CARDbuyers", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"CARDbuyers", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"CARDbuyers", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"CARDbuyers", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"CARDbuyers", "checkbudgets", &checkbudgets, true, true, false},
        {"CARDbuyers", "mnsync", &mnsync, true, true, false},
        {"CARDbuyers", "spork", &spork, true, true, false},
        {"CARDbuyers", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"CARDbuyers", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use CARDbuyersd, or the -server option to CARDbuyers-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> CARDbuyers-cli " + methodname + " " + args + "\n";
}
